...
export default function ChatInterface() {
  ...
  const handleSendMessage = async () => {
    ...
    if (selectedFile && chatMode === "support") {
      try {
        fileName = selectedFile.name; // Use original filename, no timestamp
                    ...
                    >
                      ...
                      >
                        ...
                        {showActions && (
                          ...
                          >
                            <button
                              // onClick={() => handleViewInfo(message)}
                              className="flex items-center gap-1 px-2 py-1 text-xs rounded bg-gray-100 hover:bg-gray-200 transition-colors"
                            >
        ...
        onFormSubmit={async (
          ...
          try {
            ...
            if (
              ...
              throw new Error(
                "Missing required user details for task creation."
              );
            }
            ...
            const baseTaskFields = {
              ...
              lmRef: lmRef,
              patronName:
                patrondata?.newPatronName || patrondata?.patronName || "",
